...
<head>
    <meta charset="UTF-8">
    <title>INSCRIPCIÓN A TALLERES - INTERNO</title>
...
<div class="content">
    ...
    <div class="container">
        <div class="ticket-header">
            <h2 class="text-center">INSCRIPCIÓN A TALLERES - INTERNO</h2>
        </div>
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="id_sexo" name="id_sexo" required>
                ...
                ?>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="carrera" class="form-label required-field">Carrera</label>
                ...
                <input type="hidden" id="id_tipo" name="id_tipo" value="1"> <!-- 1 = Interno -->
...
<script src="js/inscripcion_interno.js"></script>    
