...
// Consulta para obtener los datos del ticket seleccionado desde la base de datos de tickets
$query_tickets = "SELECT nticket, fecha_creacion, fecha_inicio, fecha_atencion, area, nombre, medio_soli, tipo_falla, desc_solucion, fecha_validacion, nombre_atendio, calificacion, material_1, material_2, material_3, piezas_1, piezas_2, piezas_3 FROM ticket WHERE id = ?";
$stmt_tickets = $conn_tickets->prepare($query_tickets);
$stmt_tickets->bind_param("i", $ticketId);
$stmt_tickets->execute();
$result_tickets = $stmt_tickets->get_result();
$ticket = $result_tickets->fetch_assoc();
...
// Agregar el alias para el total de páginas
$pdf->AliasNbPages();
